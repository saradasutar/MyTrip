...
No Google Apps Script update is required for this visual-only change when your login screen already shows backend **v4.3.0**.

The matching backend is included in the `backend` folder only as a backup.
