# MyTrip Google Backend 4.4 Setup

This update preserves existing trips and adds writer-attributed experience notes.
...
9. Open MyTrip and confirm the backend status says **v4.4.0**.
